...
const programs = [
  {
    ...
    description:
      "A three-year program equipping indigenous pastors to lead and multiply village churches across Africa and Asia.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Nearly 600,000 Bibles distributed in native languages so every believer can read God's Word in their own tongue.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      "Caring for orphans and training widows with practical skills, restoring dignity and hope to the most vulnerable.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      "Congregation-wide discipleship training that multiplies spiritual maturity from the inside out.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      "Established in 1990, the TTI has equipped over 13,000 students in foundational ministry and theological training.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <>
      ...
      <Hero
        ...
        imageLabel="Hero — Africa field photography"
        tall
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/africa" className="group block">
              <div className="relative overflow-hidden rounded-lg">
                <div className="w-full h-72 bg-gradient-to-br from-navy/90 to-navy/60 flex items-end justify-start p-8">
                  <span className="absolute inset-0 flex items-center justify-center font-body text-xs text-white/20 uppercase tracking-widest pointer-events-none">
                    Africa field photo
                  </span>
                  <div className="relative z-10">
                    ...
                    <p className="font-body text-white/70 text-sm mt-1">
                      11,000 village churches · 25,000 trained pastors
                    </p>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-lg">
                <div className="w-full h-72 bg-gradient-to-br from-navy/90 to-navy/60 flex items-end justify-start p-8">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="font-body text-white/70 text-sm mt-1">
                      4,000+ churches · 1,000+ new churches planted
                    </p>
                  </div>
                </div>
                <div className="bg-surface px-8 py-4 flex items-center justify-between group-hover:bg-divider transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <blockquote className="mt-8 border-l-4 border-gold pl-6">
                ...
                <cite className="block font-body text-sm text-text-muted mt-2 not-italic">
                  Ephesians 4:12
                </cite>
              </blockquote>
              <Link
                href="/about"
                className="inline-block mt-8 font-body text-sm font-semibold text-gold hover:text-gold/80 transition-colors"
              >
                Read the full story →
              </Link>
            </div>
      ...
      <section className="bg-white">
        <div className="max-w-[1200px] mx-auto px-6 py-20">
          <div className="text-center mb-12">
            ...
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-navy mt-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {programs.map((program) => (
              <div
                key={program.title}
                className="flex flex-col gap-4 p-8 border border-divider rounded-lg hover:border-gold/40 hover:shadow-sm transition-all"
              >
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-10">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-center">
            <div className="flex flex-col gap-1">
              <span className="font-heading font-bold text-2xl text-navy">1984</span>
              <span className="font-body text-xs text-text-muted uppercase tracking-widest">Founded</span>
            </div>
            <div className="hidden sm:block w-px h-10 bg-divider" />
            <div className="flex flex-col gap-1">
              <span className="font-heading font-bold text-2xl text-navy">501(c)(3)</span>
              <span className="font-body text-xs text-text-muted uppercase tracking-widest">Registered Nonprofit</span>
            </div>
            <div className="hidden sm:block w-px h-10 bg-divider" />
            <div className="flex flex-col gap-1">
              <span className="font-heading font-bold text-2xl text-navy">ECFA</span>
              <span className="font-body text-xs text-text-muted uppercase tracking-widest">Accredited Member</span>
            </div>
            <div className="hidden sm:block w-px h-10 bg-divider" />
            <div className="flex flex-col gap-1">
              <span className="font-heading font-bold text-2xl text-navy">100%</span>
              <span className="font-body text-xs text-text-muted uppercase tracking-widest">Tax Deductible</span>
            </div>
          </div>
        </div>
      </section>
